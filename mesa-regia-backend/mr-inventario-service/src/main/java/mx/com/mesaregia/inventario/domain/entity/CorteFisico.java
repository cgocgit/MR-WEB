...
public class CorteFisico {
  ...
  @Column(name = "fecha_hora_inicio", nullable = false, insertable = false, updatable = false)
  private LocalDateTime fechaHoraInicio;
  @Column(name = "fecha_hora_cierre")
  private LocalDateTime fechaHoraCierre;
  @Column(name = "id_usuario_inicio_externo", nullable = false)
  private Long idUsuarioInicioExterno;
  @Column(name = "id_usuario_cierre_externo")
  private Long idUsuarioCierreExterno;
  @Column(length = 500)
