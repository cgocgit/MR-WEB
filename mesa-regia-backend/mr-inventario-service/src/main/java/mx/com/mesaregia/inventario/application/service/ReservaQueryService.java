...
public interface ReservaQueryService { PageResponse<ReservaResponse> buscar(Long orden,EstadoReserva estado,LocalDate desde,LocalDate hasta,Pageable pageable); ReservaResponse obtener(Long idReserva); ReservaResponse obtenerPorOrden(Long idOrden); }
