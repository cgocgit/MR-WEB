...
public class MovimientoInventario {
  ...
  @Enumerated(EnumType.STRING)
  @Column(name = "origen_operacion", nullable = false, length = 30)
  private OrigenOperacion origenOperacion;
  @Column(nullable = false, columnDefinition = "INT UNSIGNED")
  private Integer cantidad;
  @Column(name = "existencia_anterior", nullable = false, columnDefinition = "INT UNSIGNED")
  private Integer existenciaAnterior;
  @Column(name = "existencia_resultante", nullable = false, columnDefinition = "INT UNSIGNED")
  private Integer existenciaResultante;
  @Column(name = "id_orden_externo")
  private Long idOrdenExterno;
  @ManyToOne(fetch = FetchType.LAZY)
  @JoinColumn(name = "id_corte_fisico")
  ...
  @Column(name = "clave_operacion", length = 100, unique = true)
