...
public class Reserva {
  ...
  @Column(name = "clave_confirmacion", length = 120, unique = true)
  private String claveConfirmacion;
  @Column(name = "id_cotizacion_externo")
  private Long idCotizacionExterno;
  @Column(name = "id_version_externa")
  private Long idVersionExterna;
  ...
  @Column(name = "referencia_salida", length = 100)
  private String referenciaSalida;
