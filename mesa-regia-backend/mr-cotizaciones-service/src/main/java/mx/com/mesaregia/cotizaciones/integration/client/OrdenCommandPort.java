...
public interface OrdenCommandPort {
  ...
  record OrdenSolicitud(Long idCotizacion, Long idCotizacionVersion, Long idClienteProspecto, String tipoCompromiso,
  ...
  record Detalle(String claveTemporal, String clavePadreTemporal, String tipoConcepto, Long idConcepto, String codigo,
      String nombre, BigDecimal cantidad, Integer orden) {
  }
}
