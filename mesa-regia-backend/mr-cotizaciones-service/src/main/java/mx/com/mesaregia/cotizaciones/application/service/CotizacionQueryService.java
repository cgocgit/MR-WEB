...
public interface CotizacionQueryService {
  PageResponse<CotizacionListItemResponse> buscar(String texto, Long cliente, EstadoCotizacion estado, LocalDate desde,
      LocalDate hasta, int page, int size);

  CotizacionResponse detalle(Long id);
}