...
public class CotizacionDetalle {
  ...
  @Column(name = "codigo_snapshot", nullable = false, length = 50)
  ...
  @Column(name = "precio_unitario_aplicado", nullable = false, precision = 14, scale = 2)
  private BigDecimal precioUnitarioAplicado;
  @Column(name = "porcentaje_adicional_aplicado", precision = 5, scale = 2)
  private BigDecimal porcentajeAdicionalAplicado;
