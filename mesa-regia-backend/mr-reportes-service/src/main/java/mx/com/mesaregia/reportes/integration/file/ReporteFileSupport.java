...
final class ReporteFileSupport {
    ...
    static String value(Object v) { return v == null ? "" : String.valueOf(v); }
    ...
    static List<List<String>> rows(ReporteResultado reporte) {
        ...
        if (!reporte.criterios().filtros().isEmpty()) out.add(List.of("Filtros", reporte.criterios().filtros().toString()));
        out.add(List.of());
    ...
    static byte[] cp1252(String s) { return s.getBytes(java.nio.charset.Charset.forName("windows-1252")); }
}
