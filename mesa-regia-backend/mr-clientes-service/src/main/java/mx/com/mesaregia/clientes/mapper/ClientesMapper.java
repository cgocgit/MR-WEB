...
public class ClientesMapper {
    ...
    public EstadoClienteProspecto estado(ClienteProspecto e) {
        if (e.getClasificacion() == Clasificacion.CLIENTE) return EstadoClienteProspecto.CLIENTE;
        if (e.getEstadoProspecto() == EstadoProspecto.REVISADO) return EstadoClienteProspecto.PROSPECTO_REVISADO;
