...
@Entity
@Table(name = "cuenta_cobro", uniqueConstraints = @UniqueConstraint(name = "uk_cuenta_cotizacion_version", columnNames = {
    "id_cotizacion_externo", "id_cotizacion_version_externo" }))
@Getter
@Setter
@NoArgsConstructor
public class CuentaCobro {
  ...
  @Column(name = "folio_cotizacion_snapshot", nullable = false, length = 50)
  private String folioCotizacionSnapshot;
  @Column(name = "numero_version_snapshot", nullable = false, columnDefinition = "SMALLINT UNSIGNED")
  private Integer numeroVersionSnapshot;
  @Column(name = "nombre_cliente_snapshot", nullable = false, length = 300)
  ...
  private EstadoCuentaCobro estado = EstadoCuentaCobro.ABIERTA;
