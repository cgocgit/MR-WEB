...
public class InternalRestClientFactory {
    ...
    public InternalRestClientFactory(InternalJwtService jwt) { this.jwt = jwt; }
    ...
    public RestClient create(String baseUrl) {
        ...
        return RestClient.builder().baseUrl(baseUrl).requestFactory(rf)
                .requestInterceptor((request, body, execution) -> {
                    ...
                    if (correlation != null && !correlation.isBlank()) request.getHeaders().set("X-Correlation-Id", correlation);
