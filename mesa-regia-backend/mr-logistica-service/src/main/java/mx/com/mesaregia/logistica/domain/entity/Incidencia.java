...
public class Incidencia {
  ...
  @JoinColumn(name = "id_etapa_logistica")
  private EtapaLogistica etapa;
  @ManyToOne(fetch = FetchType.LAZY, optional = false)
  @JoinColumn(name = "id_tipo_incidencia", nullable = false)
  private TipoIncidencia tipo;
  @Column(name = "id_orden_externo", nullable = false)
  private Long idOrdenExterno;
  @Column(name = "id_producto_externo")
  private Long idProductoExterno;
  @Column(name = "cantidad_afectada", columnDefinition = "INT UNSIGNED")
  ...
  @Column(name = "id_usuario_reporta_externo", nullable = false)
  private Long idUsuarioReportaExterno;
  @Column(name = "id_supervisor_externo")
