...
@Entity
@Table(name = "asignacion_logistica")
@Getter
@Setter
@NoArgsConstructor
public class AsignacionLogistica {
  ...
  @Column(name = "id_asignacion_logistica")
  private Long id;
  ...
  @Column(name = "orden_parada", nullable = false, columnDefinition = "SMALLINT UNSIGNED")
  private Integer ordenParada;
  @Column(name = "fecha_hora_programada")
  private LocalDateTime fechaHoraProgramada;
  @Column(name = "domicilio_snapshot", length = 500)
