...
public interface ProgramacionLogisticaRepository extends JpaRepository<ProgramacionLogistica, Long> {
  @Query("""
      ...
      """)
  Page<ProgramacionLogistica> buscar(@Param("estado") EstadoProgramacion estado, @Param("desde") LocalDateTime desde,
  ...
  @Query("""
      ...
      """)
  boolean existeConflicto(@Param("id") Long id, @Param("fecha") LocalDateTime fecha, @Param("chofer") Long chofer,
      @Param("representante") Long representante, @Param("vehiculoId") Long vehiculoId,
      @Param("cancelada") EstadoProgramacion cancelada, @Param("realizada") EstadoProgramacion realizada);
}
