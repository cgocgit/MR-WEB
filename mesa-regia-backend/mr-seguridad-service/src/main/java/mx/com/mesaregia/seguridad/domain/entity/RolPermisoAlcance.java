...
@Setter
@Entity
@Table(name = "rol_permiso_alcance", uniqueConstraints = @UniqueConstraint(name = "uk_rol_permiso_alcance", columnNames = {
    "id_rol", "id_permiso", "alcance" }))
public class RolPermisoAlcance {
  @Id
  @GeneratedValue(strategy = GenerationType.IDENTITY)
  @Column(name = "id_rol_permiso_alcance")
  private Long id;
